...
if (version_compare(TYPO3_version, '9.0', '<')) {
    $extensionConfiguration = unserialize($GLOBALS['TYPO3_CONF_VARS']['EXT']['extConf']['ig_ldap_sso_auth'] ?? '');
} else {
    $extensionConfiguration = $GLOBALS['TYPO3_CONF_VARS']['EXTENSIONS']['ig_ldap_sso_auth'];
}
$EXT_CONFIG = is_array($extensionConfiguration) ? $extensionConfiguration : [];
