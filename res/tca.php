...
$TCA["tx_igldapssoauth_config"] = array (
	...
	"columns" => array (
		...
		"cas_uri" => Array (
			"exclude" => 1,
			"label" => "LLL:EXT:ig_ldap_sso_auth/res/locallang_db.xml:tx_igldapssoauth_config.cas_uri",
			"config" => Array (
				"type" => "input",
				"size" => "30",
				"max" => "255",
		...
		"cas_service_url" => Array (
			"exclude" => 1,
			"label" => "LLL:EXT:ig_ldap_sso_auth/res/locallang_db.xml:tx_igldapssoauth_config.cas_service_url",
			"config" => Array (
				"type" => "input",
				"size" => "30",
				"max" => "255",
